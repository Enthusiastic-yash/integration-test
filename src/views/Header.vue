        ...
        <v-container fluid class="pa-0">
            ...
            <div>
                        ...
                        <div class=" h-100  d-none d-md-flex  ">
                            <v-sheet color="lightWhite mr-6" :width="200">
                                ...
                                <div class="d-flex align-center">
                                    ...
                                    <v-icon icon="mdi-circle" size="15" color="yellow "></v-icon>
                                    <div class=" ml-4">
                                        <v-icon icon="mdi-star" size="20" color="yellow"></v-icon>
                                        <v-icon icon="mdi-star" size="20" color="yellow"></v-icon>
                                        <v-icon icon="mdi-star" size="20" color="yellow"></v-icon>
                                        <v-icon icon="mdi-star" size="20" color="yellow"></v-icon>
                                        <v-icon icon="mdi-star-half-full" size="20" color="yellow"></v-icon>
                                    </div>
                ...
                <v-navigation-drawer v-model="drawer" location="top" :temporary="true">
                    <div>
                        <v-expansion-panels>
                            <v-expansion-panel v-for=" (subItems, index)  in  dropItems " :key="subItems.index"
                                :value="index" elevation="0">
...
const dropItems = ref([
    { title: 'Teams', routes: [{ path: '/team1', name: 'Team 1', exact: false }, { path: '/team2', name: 'Team 2', exact: false }, { path: '/team3', name: 'Team 3', exact: false }] },
    { title: 'Tournaments', routes: [{ path: '/Tournaments1', name: 'Tournaments 1', exact: false }, { path: '/Tournaments2', name: 'Tournaments 2', exact: false }, { path: '/Tournaments3', name: 'Tournaments 3', exact: false }] },
    { title: 'Stadiums', routes: [{ path: '/Stadiums1', name: 'Stadiums 1', exact: false }, { path: '/Stadiums2', name: 'Stadiums 2', exact: false }, { path: '/Stadiums3', name: 'Stadiums 3', exact: false }] },
